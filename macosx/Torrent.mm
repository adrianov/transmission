...
/// Returns YES if text (torrent name, comment, or file path) contains adult heuristic keywords or tags.
...
/// Returns YES if any tracker announce URL host is the adult tracker (e.g. pornolab.net).
...
/// Returns YES if trackers list or Comment contains adult tracker domain (Comment often has tracker URL/domain).
...
/// YES if torrent is from adult tracker (e.g. pornolab.net) or video with adult heuristic in name/comment.
- (BOOL)isAdultTorrent
{
