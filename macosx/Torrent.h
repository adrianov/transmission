...
/// Files, playable media, and play-button layout cache.
@property(nonatomic, readonly) TorrentContent* content;

- (instancetype)initWithPath:(NSString*)path location:(NSString*)location deleteTorrentFile:(BOOL)torrentDelete lib:(tr_session*)lib;
...
@property(nonatomic, nullable) NSIndexSet* previousFinishedPieces;
...
+ (BOOL)trashFile:(NSString*)path error:(NSError* _Nullable*)error;
...
@property(nonatomic, readonly) NSArray<NSString*>* allTrackersFlat;
- (BOOL)addTrackerToNewTier:(NSString*)tracker;
- (void)removeTrackers:(NSSet*)trackers;

@property(nonatomic, readonly) NSString* comment;
@property(nonatomic, readonly, nullable) NSURL* commentURL;
...
- (void)renameTorrent:(NSString*)newName completionHandler:(void (^ _Nullable)(BOOL didRename))completionHandler;
- (void)renameFileNode:(FileListNode*)node withName:(NSString*)newName completionHandler:(void (^ _Nullable)(BOOL didRename))completionHandler;
...
@property(nonatomic, readonly) NSString* statusStringForTooltip;
...
@property(nonatomic, readonly, nullable) NSDate* dateCompleted;
@property(nonatomic, readonly) NSDate* dateActivity;
@property(nonatomic, readonly) NSDate* dateActivityOrAdd;
@property(nonatomic, readonly, nullable) NSDate* dateLastPlayed;
...
#import "TorrentContent/TorrentContent.h"
