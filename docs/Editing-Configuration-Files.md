 ...
 * **sleep_per_seconds_during_verify:** Number (default = 0) Milliseconds to pause once per second during verification to reduce disk I/O pressure. Set to e.g. 100 to throttle verify speed when downloading on the same disk.
