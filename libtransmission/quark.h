...
enum // NOLINT(performance-enum-size)
{
    ...
    TR_KEY_announce_ip_kebab_APICOMPAT, /* settings (legacy) */
    TR_KEY_announce_ip_enabled_kebab_APICOMPAT, /* settings (legacy) */
    ...
    TR_KEY_blocklist_update_kebab_APICOMPAT,
    TR_KEY_blocklist_updates_enabled_kebab_APICOMPAT,
    ...
    TR_KEY_code,
    TR_KEY_comment,
    TR_KEY_compact_view_kebab_APICOMPAT,
    TR_KEY_compact_view,
    TR_KEY_complete,
    ...
    TR_KEY_destination,
    TR_KEY_details_window_height_kebab_APICOMPAT,
    TR_KEY_details_window_width_kebab_APICOMPAT,
    ...
    TR_KEY_flags,
    TR_KEY_format,
    TR_KEY_free_space_kebab_APICOMPAT,
    TR_KEY_free_space,
    ...
    TR_KEY_inspector_show_piece_availability_kebab_APICOMPAT,
    TR_KEY_inspector_show_piece_availability,
    TR_KEY_ip_protocol,
    TR_KEY_ipv4,
    TR_KEY_ipv6,
    ...
    TR_KEY_magnet_link,
    TR_KEY_main_window_height_kebab_APICOMPAT,
    TR_KEY_main_window_is_maximized_kebab_APICOMPAT,
    TR_KEY_main_window_layout_order_kebab_APICOMPAT,
    TR_KEY_main_window_width_kebab_APICOMPAT,
    TR_KEY_main_window_x_kebab_APICOMPAT,
    TR_KEY_main_window_y_kebab_APICOMPAT,
    ...
    TR_KEY_memory_units,
    TR_KEY_message,
    TR_KEY_message_level_kebab_APICOMPAT,
    ...
    TR_KEY_nodes,
    TR_KEY_nodes6,
    TR_KEY_open_dialog_dir_kebab_APICOMPAT,
    ...
    TR_KEY_peer_congestion_algorithm_kebab_APICOMPAT,
    ...
    TR_KEY_peer_port_random_high_kebab_APICOMPAT,
    TR_KEY_peer_port_random_low_kebab_APICOMPAT,
    TR_KEY_peer_port_random_on_start_kebab_APICOMPAT,
    TR_KEY_peer_socket_tos_kebab_APICOMPAT,
    ...
    TR_KEY_port_test_kebab_APICOMPAT,
    ...
    TR_KEY_queue_move_top_kebab_APICOMPAT,
    TR_KEY_queue_move_up_kebab_APICOMPAT,
    ...
    TR_KEY_rate_to_peer,
    TR_KEY_rate_upload,
    TR_KEY_ratio_limit_kebab_APICOMPAT,
    TR_KEY_ratio_limit_enabled_kebab_APICOMPAT,
    ...
    TR_KEY_remote_session_host_kebab_APICOMPAT,
    TR_KEY_remote_session_https_kebab_APICOMPAT,
    TR_KEY_remote_session_password_kebab_APICOMPAT,
    TR_KEY_remote_session_port_kebab_APICOMPAT,
    TR_KEY_remote_session_requres_authentication_kebab_APICOMPAT,
    TR_KEY_remote_session_username_kebab_APICOMPAT,
    ...
    TR_KEY_rpc_host_whitelist_kebab_APICOMPAT,
    TR_KEY_rpc_host_whitelist_enabled_kebab_APICOMPAT,
    TR_KEY_rpc_password_kebab_APICOMPAT,
    TR_KEY_rpc_port_kebab_APICOMPAT,
    TR_KEY_rpc_socket_mode_kebab_APICOMPAT,
    TR_KEY_rpc_url_kebab_APICOMPAT,
    TR_KEY_rpc_username_kebab_APICOMPAT,
    TR_KEY_rpc_version_kebab_APICOMPAT,
    TR_KEY_rpc_version_minimum_kebab_APICOMPAT,
    TR_KEY_rpc_version_semver_kebab_APICOMPAT,
    TR_KEY_rpc_whitelist_kebab_APICOMPAT,
    TR_KEY_rpc_whitelist_enabled_kebab_APICOMPAT,
    ...
    TR_KEY_scrape,
    TR_KEY_scrape_paused_torrents_enabled_kebab_APICOMPAT,
    ...
    TR_KEY_session_set_kebab_APICOMPAT,
    TR_KEY_session_stats_kebab_APICOMPAT,
    ...
    TR_KEY_show_pieces_bar_kebab_APICOMPAT,
    ...
    TR_KEY_start_minimized_kebab_APICOMPAT,
    ...
    TR_KEY_tcp_enabled,
    TR_KEY_tier,
    TR_KEY_time_checked_kebab_APICOMPAT,
    TR_KEY_time_checked,
    TR_KEY_torrent_add_kebab_APICOMPAT,
    TR_KEY_torrent_added_kebab_APICOMPAT,
    TR_KEY_torrent_added_notification_enabled_kebab_APICOMPAT,
    TR_KEY_torrent_added_verify_mode_kebab_APICOMPAT,
    TR_KEY_torrent_complete_notification_enabled_kebab_APICOMPAT,
    TR_KEY_torrent_complete_sound_command_kebab_APICOMPAT,
    TR_KEY_torrent_complete_sound_enabled_kebab_APICOMPAT,
    TR_KEY_torrent_duplicate_kebab_APICOMPAT,
    TR_KEY_torrent_get_kebab,
    TR_KEY_torrent_reannounce_kebab_APICOMPAT,
    TR_KEY_torrent_remove_kebab_APICOMPAT,
    TR_KEY_torrent_rename_path_kebab_APICOMPAT,
    TR_KEY_torrent_set_kebab_APICOMPAT,
    TR_KEY_torrent_set_location_kebab_APICOMPAT,
    TR_KEY_torrent_start_kebab_APICOMPAT,
    TR_KEY_torrent_start_now_kebab_APICOMPAT,
    TR_KEY_torrent_stop_kebab_APICOMPAT,
    TR_KEY_torrent_verify_kebab_APICOMPAT,
    ...
    TR_KEY_url_list,
    TR_KEY_upload_speed_history,
    TR_KEY_upload_speed_history_enabled,
    TR_KEY_upload_speed_auto_adjust,
    ...
    TR_KEY_version,
    TR_KEY_wanted,
    TR_KEY_watch_dir_kebab_APICOMPAT,
    TR_KEY_watch_dir_enabled_kebab_APICOMPAT,
    TR_KEY_watch_dir_force_generic_kebab_APICOMPAT,
    TR_KEY_watch_dir,
