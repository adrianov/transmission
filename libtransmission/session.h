...
private:
#include "libtransmission/session-mediators.h"
...
public:
    ...
    {
        auto var = libtransmission::serializer::Converters::serialize(settings_.preferred_transports);
        TR_ASSERT(var.has_value());
        return var;
    }
