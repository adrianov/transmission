...
import { HumanTitle } from './human-title/human-title.js';
...
export const Formatter = {
  ...
  episodeTitle(name, torrentName) {
    return HumanTitle.episodeTitle(name, torrentName);
  },

  humanFileName(name) {
    return HumanTitle.fileName(name);
  },

  humanTitle(name) {
    return HumanTitle.format(name);
  },
